...
namespace CheckedAppProject.API.Controllers
{
    ...
    public class UserItemController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllUsersItemsByStateInItemList(
            [FromRoute] UserItemState state,
            [FromRoute] int id
        )
        {
            if (!ModelState.IsValid)
        ...
        public async Task<IActionResult> EditUserItemStatus(
            [FromBody] UserItemState state,
            [FromRoute] int id
        )
        {
            if (!ModelState.IsValid)
