            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserItemId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ItemListId1 = table.Column<string>(type: "text", nullable: true),
                    ItemListId = table.Column<int>(type: "integer", nullable: false),
                    ItemId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserItems_ItemLists_ItemListId1",
                        column: x => x.ItemListId1,
